...
export default function InsightsPanel() {
  ...
  const requestInsights = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.message || 'Failed to get insights')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-700">
          <strong>AI-Powered Analysis:</strong> Get personalized suggestions and insights based on your transaction history.
          Powered by Ollama.
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-gray-700 whitespace-pre-wrap">
                {resp.analysis || 'No analysis available'}
              </div>
            </div>
          </div>
        )}
        ...
        {!resp && !loading && !error && (
          <div className="text-center py-12 text-gray-400">
            ...
            <p>Click "Get AI Insights" to analyze your transactions</p>
          </div>
        )}
      </div>
    </div>
